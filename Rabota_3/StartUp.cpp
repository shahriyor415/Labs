...
InterruptHandler::Timer2Handler, // TIM2, 28 строка от системного таймера
...
InterruptHandler::DummyHandler,
InterruptHandler::DummyHandler,
InterruptHandler::Timer5Handler, // TIM5, 50 строкa от системного таймера (по библии на file:///R:/POIP/POIP/stm32f411_1.pdf)
InterruptHandler::DummyHandler,
InterruptHandler::DummyHandler,
InterruptHandler::DummyHandler,
InterruptHandler::DummyHandler,
